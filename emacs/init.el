...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/OneDrive - A.O. Smith Corporation/work/HVAC Course/Day2.org"))
 '(package-selected-packages
   '(evil-easymotion org-autolist csv-mode evil-magit color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized helm-projectile magit company-jedi gruvbox-theme neotree which-key autopair evil-surround evil-escape rainbow-delimiters company helm-slime slime evil-collection evil))
